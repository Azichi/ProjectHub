...
No logic. Just constants, flags, and config dicts.
"""

from typing import Dict, Tuple, Any
import logging

# Z/tilt correction for position estimation
...
# Flags for enabling GUI, sliders, and YOLO
USE_GUI: bool = True
...
# Camera and depth
CAMERA_LEFT_MM = 177.0
CAMERA_ABOVE_BASE_MM  = 170.5
MASK_OVERLAP_OK: float = 0.95
DEPTH_MIN_MM: int = 500
DEPTH_MAX_MM: int = 5000
DEPTH_OFFSET_MM = 0

# Which slider groups are enabled in GUI
ACTIVE_GROUPS = [
    #"circle",
    #"square",
    "rectangle",
...
SLIDER_CONFIG: Dict[str, Dict[str, Any]] = {
    ...
    "B S min": {"default": 75, "max": 255, "group": "hsv_blue"},
    "B S max": {"default": 255, "max": 255, "group": "hsv_blue"},
    "B V min": {"default": 60, "max": 205, "group": "hsv_blue"},
    ...
    "minRadius": {"default": 25, "max": 200, "group": "circle"},
    ...
    "c_circ": {"default": 70, "max": 100, "group": "circle"},
    "c_iou_thr": {"default": 60, "max": 100, "group": "circle"},
    # Square Detection
    ...
    "s_eps": {"default": 50, "max": 500, "group": "square"},
    ...
    # Rectangle Detection
    "r_min_area":  {"default": 0,   "max": 10000,  "group": "rectangle"},
    "r_max_area":  {"default": 300000, "max": 300000, "group": "rectangle"},
    "r_asp_min":   {"default": 50,     "max": 300,    "group": "rectangle"},  # aspect-ratio min (%)
    "r_asp_max":   {"default": 400,    "max": 500,    "group": "rectangle"},  # aspect-ratio max (%)
    "r_eps":       {"default": 26,     "max": 50,     "group": "rectangle"},  # ε for approxPolyDP (permille)
    "r_sol":       {"default": 70,     "max": 100,    "group": "rectangle"},  # solidity threshold (%)
    "r_ext":       {"default": 60,     "max": 100,    "group": "rectangle"},  # extent threshold (%)
    ...
    # Weights
    "Color Weight": {"default": 15, "max": 100, "group": "evaluation"},
    "Shape Weight": {"default": 15, "max": 100, "group": "evaluation"},
    ...
    "Decision Accept Threshold": {"default": 5, "max": 390, "group": "evaluation"},
    # focus and Tracking
    "focus": {"default": 140, "max": 200, "group": "camera"},
    "tr_alpha": {"default": 1, "max": 100, "group": "tracking"},
